...
// biome-ignore lint/performance/noNamespaceImport: this shared primitive relies on React namespace types throughout the file.
...
function persistSidebarState(openState: boolean) {
  ...
  const cookieStore = browserWindow.cookieStore;
  ...
  if (cookieStore) {
    cookieStore
      ...
      .catch(() => {
        browserWindow.localStorage.setItem(SIDEBAR_COOKIE_NAME, value);
      });
    return;
  }
